    ...
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-4">
      ...
      <Card className="relative w-full max-w-md border-white/10 bg-black/40 backdrop-blur-md p-8 rounded-2xl">
        ...
        <h1 className="text-2xl font-bold text-white text-center mb-1">
          {isLogin ? "Sign In" : <>Create a <span className="brand-text"><span className="brand-text-thats">thats</span><span className="brand-text-dot">.</span><span className="brand-text-wtf">wtf</span></span> account</>}
        </h1>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <div className="absolute left-10 top-1/2 -translate-y-1/2 text-white text-sm font-medium">
                        ...
                        <Input
                          {...field}
                          className="bg-white/5 border-white/10 text-white placeholder:text-muted-foreground pl-28"
